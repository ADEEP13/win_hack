...
export default function ConsumerApp() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      <h1 className="text-4xl font-bold text-agri-green mb-4">🔍 Consumer Trace</h1>
      <p className="text-slate-600 mb-8">Scan the QR code on your food packaging to see its complete journey from farm to table.</p>
      ...
      {!scanned ? (
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          ...
          <button
            ...
            className="bg-agri-green text-white px-8 py-3 rounded-lg font-bold text-lg hover:opacity-90 transition inline-block"
          >
            📷 Scan QR Code
          </button>
